...
const questions = [
  {
    ...
    scenario: "你剛睡醒，發現自己身處陌生的空間。一位神秘的存在告訴你，你必須前往異世界解決一場危機。你的第一個反應是？",
    options: [
      { label:"A", text:"詢問詳盡細節，世界觀甚至歷史都想先了解。", type:"A" },
      { label:"B", text:"嘆氣接受，雖然不安卻已開始準備行前計劃書。", type:"B" },
      { label:"C", text:"內心不願意被安排命運，嘗試找尋空間是否有出口。", type:"C" },
      { label:"D", text:"點一下就同意了，冒險不才是人生嗎？", type:"D" }
    ]
  },
  {
    chapter: "2. 抉擇：陌生的荒野",
    scenario: "降落在異世界的一片森林中，遠處傳來陌生動物的嘶吼聲。你會？",
    options: [
      { label:"A", text:"蹲低週邊觀察植物花紋判斷氣候環境。", type:"A" },
      { label:"B", text:"開始翻找什麼都可用的石頭，撿取木棒準備自衛。", type:"B" },
      { label:"C", text:"靜靜不動聽辨叫聲方向，避開危險路線再移動。", type:"C" },
      { label:"D", text:"嘗試與動物對視看看其中是否有友好的生物接觸它。", type:"D" }
    ]
  },
  {
    chapter: "3. 遭遇：對待商旅的態度",
    scenario: "你遇見一位受傷的商人，他的貨物散落一地。遠處，盜賊的氣息在風裡。你會？",
    options: [
      { label:"A", text:"優先照顧商人的安全，判斷傷勢是否需要即刻救治。", type:"A" },
      { label:"B", text:"快速思考，在不影響自身在這個世界裡安全的地方保護商人。", type:"B" },
      { label:"C", text:"先觀察附近環境，快速找到藏匿貨物的安全位置藏起來。", type:"C" },
      { label:"D", text:"看見傷者的手足無措，同情心湧上，主動說「別怕，我會留下」。", type:"D" }
    ]
  },
  {
